...
def update_line_plot(sample, gene):
    ...
    try:
        ...
        counts_data = pdlp.prepare_counts_file(counts_file)
        
        genome_reference = pdlp.get_genome_reference_of_gene(gene, counts_data)
        
        bedgraph_data = pdlp.prepare_bedgraph_file(path_bedgraph, genome_reference)
...
def get_sequence(relayout_data, gene):
